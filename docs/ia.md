...
Ninguna de las seis se atrapó por relectura visual del código antes de ejecutarlo. Las cinco primeras se atraparon porque algo real falló (un test, un build, un contenedor) y la metodología del candidato prohíbe declarar una fase terminada sin haber corrido el comando real y leído su salida. La sexta se atrapó porque la gobernanza incluye una auditoría de seguridad *dirigida*, no solo pruebas funcionales. Esa disciplina — no la inteligencia para prevenir el error de antemano — es la garantía real de calidad de este proceso, y es reproducible en cualquier proyecto futuro que use la misma metodología.
